...
const colorClasses = {
  ...
  secondary:
    'bg-action-background-secondary text-action-text-secondary disabled:bg-action-disabled-secondary',
  'border-default':
    'border border-foreground text-foreground hover:bg-foreground hover:text-background disabled:border-foreground-disabled disabled:text-foreground-disabled',
  'border-primary':
    'border border-action-text text-action-text hover:bg-action-text hover:text-action-background disabled:border-action-disabled disabled:text-action-disabled',
